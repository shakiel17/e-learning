                    ...
                    <tbody>
                        ...
                        foreach($users as $item){ 
                            ...
                            echo "<tr>";
                                ...
                                ?>
                                <td>
                                    <a href="#" class="btn btn-warning btn-sm editQuiz" data-toggle="modal" data-target="#ManageQuiz" data-id="<?=$item['id'];?>_<?=$topic['id'];?>_<?=$lesson['id'];?>_<?=$item['description'];?>"><i class="glyphicon glyphicon-edit"></i> Edit</a>                                    
